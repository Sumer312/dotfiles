...
function ColorMyPencils(color)
	...
	set(0, "TabLineSel", { bg = palatte.autumnYellow, fg = palatte.dragonBlack0, bold = true, italic = true })
	set(0, "Title", { bg = "none", fg = palatte.fujiWhite, bold = true })
	...
	set(0, "MsgSeparator", { bg = palatte.waveBlue1 })
