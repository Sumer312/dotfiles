...
function ColorMyPencils(color)
  ...
  set(0, "Visual", { bg = palatte.lotusCyan, fg = palatte.dragonBlack0 })
  ...
  set(0, "FloatTitle", { bg = "none", fg = palatte.lotusCyan, bold = true, italic = true })
  ...
  set(0, "DiagnosticSignWarn", { fg = palatte.roninYellow, bg = "none" })
  set(0, "DiagnosticSignHint", { fg = palatte.lightBlue, bg = "none" })
  ...
  set(0, "TreesitterContextLineNumber", { bg = "none", fg = palatte.sakuraPink, bold = true, italic = true, underdotted = true })
