...
function ColorMyPencils(color)
  ...
  set(0, "FloatTitle", { bg = "none", fg = palatte.waveRed, bold = true, italic = true })
  ...
  set(0, "PmenuThumb", { bg = palatte.waveRed })
  ...
  set(0, "DiagnosticFloatingError", { fg = palatte.samuraiRed, bg = "none", italic = true })
  set(0, "DiagnosticFloatingWarn", { fg = palatte.surimiOrange, bg = "none", italic = true })
  set(0, "DiagnosticFloatingHint", { fg = palatte.lotusCyan, bg = "none", italic = true })
  set(0, "DiagnosticFloatingInfo", { fg = palatte.springBlue, bg = "none", italic = true })

  set(0, "DiagnosticVirtualTextError", { fg = palatte.samuraiRed, bg = "none", italic = true })
  set(0, "DiagnosticVirtualTextWarn", { fg = palatte.surimiOrange, bg = "none", italic = true })
  set(0, "DiagnosticVirtualTextHint", { fg = palatte.lotusCyan, bg = "none", italic = true })
  ...
  set(0, "TelescopeSelectionCaret", { bg = "none", fg = palatte.sakuraPink })
  ...
  set(0, "TreesitterContextLineNumber", { bg = "none", fg = palatte.sakuraPink, bold = true, italic = true })
  ...
  set(0, "NotificationWarning", { bg = palatte.surimiOrange, fg = palatte.dragonBlack0 })
  set(0, "NotificationError", { bg = palatte.samuraiRed, fg = palatte.dragonBlack0 })
