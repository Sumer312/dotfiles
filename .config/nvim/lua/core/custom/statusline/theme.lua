...
M.ColorMyLines = function()
  ...
  set(0, "TerminalAccent", { bg = palatte.winterRed, fg = palatte.fujiWhite, bold = true })
  ...
  set(0, "TerminalBlackBg", { bg = palatte.fujiWhite, fg = palatte.dragonBlack0, bold = true, italic = true })
  ...
  set(0, "TerminalInverse", { bg = palatte.winterRed, fg = palatte.fujiWhite, bold = true, italic = true })
end
return M
