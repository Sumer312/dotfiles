...
M.ColorMyLines = function()
  ...
  set(0, "VisualAccent", { bg = palatte.lotusCyan, fg = palatte.dragonBlack0, bold = true })
  set(0, "CmdLineAccent", { bg = palatte.springBlue, fg = palatte.dragonBlack0, bold = true })
  set(0, "ReplaceAccent", { bg = palatte.springViolet1, fg = palatte.dragonBlack0, bold = true })
  ...
  set(0, "VisualBlackBg", { bg = palatte.dragonBlack0, fg = palatte.lotusCyan, bold = true, italic = true })
  set(0, "CmdLineBlackBg", { bg = palatte.dragonBlack0, fg = palatte.springBlue, bold = true, italic = true })
  set(0, "ReplaceBlackBg", { bg = palatte.dragonBlack0, fg = palatte.springViolet1, bold = true, italic = true })
  ...
  set(0, "VisualInverse", { bg = palatte.lotusCyan, fg = palatte.dragonBlack0, bold = true, italic = true })
  set(0, "CmdLineInverse", { bg = palatte.springBlue, fg = palatte.dragonBlack0, bold = true, italic = true })
  set(0, "ReplaceInverse", { bg = palatte.springViolet1, fg = palatte.dragonBlack0, bold = true, italic = true })
